  ...
  <div class="app-container">
    ...
    <div>
      <el-row>
        ...
        <el-col :span="2.5">
          <el-input-number v-model="query.rateFrom" placeholder="占用率从"
                           controls-position="right">
          </el-input-number>
        </el-col>
        <el-col :span="2.5">
          <el-input-number v-model="query.rateTo" placeholder="占用率到"
                           controls-position="right">
          </el-input-number>
        </el-col>
        <!--        todo 按照状态查询 -->
        <el-col :span="2">
          <el-select v-model="query.completeStatus" clearable placeholder="状态">
      ...
      <el-table-column type="expand">
        <template slot-scope="scope">
          <el-table :data="scope.row.children" max-height="250" border
            ...
            <el-table-column label="关联单位" prop="correlationUnit"></el-table-column>
